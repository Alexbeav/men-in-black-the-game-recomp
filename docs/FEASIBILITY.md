...
The supported serial set is `SLES-01047`. The package uses
...
The corrected source uses `Men_in_Black__The_Game_Recompiled` for CMake, the setup relaunch, and packaging.
