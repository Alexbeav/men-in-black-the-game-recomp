...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "men-in-black-the-game-",
    .project_root_env = "MEN_IN_BLACK_THE_GAME_RECOMP_PROJECT_ROOT",
    .build_dir_env = "MEN_IN_BLACK_THE_GAME_RECOMP_BUILD_DIR",
    .force_setup_env = "MEN_IN_BLACK_THE_GAME_RECOMP_FORCE_SETUP",
