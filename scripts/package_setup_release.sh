...
#
# Writes: dist/Men-in-Black-The-Game-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix Men-in-Black-The-Game-Recomp \
  --exe-name Men_in_Black__The_Game_Recompiled \
  --display-name "Men in Black: The Game Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Men in Black: The Game disc" \
