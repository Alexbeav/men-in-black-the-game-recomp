# Men in Black: The Game Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/men-in-black-the-game-recomp/total)](https://github.com/Alexbeav/men-in-black-the-game-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/men-in-black-the-game-recomp/latest/total)](https://github.com/Alexbeav/men-in-black-the-game-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/men-in-black-the-game-recomp)](https://github.com/Alexbeav/men-in-black-the-game-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Men in Black: The Game** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Men in Black: The Game.
...
Zip prefix for CI artifacts: `Men-in-Black-The-Game-Recomp`.
...
The `v0.3.3` source uses `Men_in_Black__The_Game_Recompiled` in CMake, the setup relaunch, and the packager.
